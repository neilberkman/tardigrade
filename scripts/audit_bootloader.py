...
# load_clean_write_trace, load_clean_erase_trace, build_clean_operation_trace,
# and annotate_fault_windows are imported from trace_utils.py.
...
# _fault_type_label is imported from fault_types.py (single source of truth).
